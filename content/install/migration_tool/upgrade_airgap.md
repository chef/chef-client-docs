+++
title = "Upgrade Chef Infra Client to version 19 RC2 using the migration tool in an air-gapped environment"
...
This page documents how to upgrade Chef Infra Client to version 19 RC2 in an air-gapped environment.

## Supported platforms

The Chef Infra Client migration tool is supported on:
