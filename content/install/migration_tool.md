...
identifier = "install/migration-tool"
parent = "install"
weight = 10
+++
...
To upgrade to Chef Infra Client 19 RC2 from an earlier major version, see the [upgrade documentation]({{< relref "install/upgrade" >}}).
