...
## Supported Knife plugins

Knife 19 RC3 includes a carefully curated selection of plugins to support enterprise deployment scenarios:

### knife-ec2: Amazon Web Services integration

- **EC2 instance management**: Complete lifecycle management for Amazon EC2 instances
- **Bootstrap capabilities**: Direct provisioning and Chef Infra Client installation on AWS instances
- **Security group integration**: Native support for AWS security groups and networking configurations
- **Tag management**: Comprehensive AWS resource tagging for compliance and cost management
- **Multi-region support**: Deploy and manage instances across multiple AWS regions

### knife-google: Google Cloud Platform integration

- **Compute Engine management**: Full integration with Google Cloud Compute Engine for instance provisioning
- **Project-based deployment**: Native support for GCP project structures and organizational hierarchies
- **Machine type flexibility**: Support for all GCP machine types and custom configurations
- **Image management**: Integration with both public and custom GCP images
- **Zone-based deployment**: Strategic placement of resources across GCP availability zones

### knife-windows: Windows node management

- **WinRM-based operations**: Secure remote management using Windows Remote Management protocol
- **PowerShell integration**: Native execution of PowerShell commands and scripts on remote Windows nodes
- **Service management**: Comprehensive management of Chef Infra Client service on Windows systems
- **Certificate management**: Robust handling of SSL/TLS certificates for secure WinRM communications
- **Domain integration**: Support for Active Directory domain-joined Windows systems
