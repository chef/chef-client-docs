...
- Use [knife ssl check](https://docs.chef.io/workstation/latest/tools/knife/knife_ssl_check/) to troubleshoot SSL certificate issues.
- Use [knife ssl fetch](https://docs.chef.io/workstation/latest/tools/knife/knife_ssl_fetch/) to pull down a certificate from Chef Infra Server to the `/.chef/trusted_certs` directory on the workstation.
...
Run [`knife ssl check`](https://docs.chef.io/workstation/latest/tools/knife/knife_ssl_check/) to verify the state of the SSL certificate, and then use the response to help troubleshoot any issues.
...
Run [`knife ssl fetch`](https://docs.chef.io/workstation/latest/tools/knife/knife_ssl_fetch/) to download the self-signed certificate from Chef Infra Server to the `/.chef/trusted_certs` directory on a workstation.
