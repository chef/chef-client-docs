...
| [rpm_package](https://docs.chef.io/resources/rpm_package/) | Centos 9 | The rpm package need to be available on remote locally. |
...
| [subversion](https://docs.chef.io/resources/subversion/) | Ubuntu 24.04, Linux Red Hat 9, centOS 9 | Warning: The subversion resource has known bugs and may not work as expected. For more information see Chef GitHub issues, particularly #4050 and #4257. |
